...
const Hero = () => {
  return (
   ...
   <nav className='flex justify-between w-full items-center mb-10 pt-3'>
    ...
    <button type='button' onClick={()=>window.open('https://www.linkedin.com/feed/')} className='black_btn'>Github</button>
   </nav>
   <h1 className='head_text'>
    Summarize Article with <br className='max-md:hidden'/>
    <span className='orange_gradient'>Open Gpt-4 For</span>
   </h1>
   <p className='desc'> Simplify your reading with Summize, an open-source article summarizer
